...
models_dir = "models/public_use_microdata_sample/generated/enum_types_mapped_renamed"
...
{{{{ config(materialized='external', location=var('output_path') + '/{materialized_name}_enum_types_mapped_renamed.parquet') }}}}
...
FROM read_csv('{csv_path}', 
    ...
    sql_file_path = os.path.join(models_dir, f"{materialized_name}_enum_mapped_renamed.sql")
