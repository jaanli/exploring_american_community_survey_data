...
echo "Step 1: Listing URLs of the $YEAR 1-Year ACS PUMS data and data dictionary"
...
echo "Step 1: Saving the database of the $YEAR 1-Year ACS PUMS data and data dictionary"
