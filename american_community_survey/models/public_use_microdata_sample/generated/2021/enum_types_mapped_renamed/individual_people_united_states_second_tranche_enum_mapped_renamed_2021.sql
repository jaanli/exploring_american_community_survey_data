...
{{ config(materialized='external', location=var('output_path') + '/2021_acs_pums_individual_people_united_states_second_tranche.parquet') }}
...
CASE CITWP
		...
		WHEN '1944' THEN '1944 or earlier - Bottom-coded'
		WHEN '1945' THEN '1945 - 1947'
		...
		WHEN '2020' THEN '2020'
		WHEN '2021' THEN '2021'
	END::ENUM ('Not applicable - Not eligible - not naturalized','1944 or earlier - Bottom-coded','1945 - 1947','1948 - 1949','1950 - 1951','1952','1953','1954','1955','1956','1957','1958','1959','1960','1961','1962','1963','1964','1965','1966','1967','1968','1969','1970','1971','1972','1973','1974','1975','1976','1977','1978','1979','1980','1981','1982','1983','1984','1985','1986','1987','1988','1989','1990','1991','1992','1993','1994','1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018','2019','2020','2021') AS "Year of naturalization write-in",
CASE COW
...
CASE HINS7
    ...
    INTP::VARCHAR AS "Interest, dividends, and net rental income past 12 months (signed, use ADJINC to adjust to constant dollars)",
...
CASE MARHYP
		...
		WHEN '2020' THEN '2020'
		WHEN '2021' THEN '2021'
	END::ENUM ('Not applicable - age less than 15 years; never married','1943 or earlier - Bottom-coded','1944','1945','1946','1947','1948','1949','1950','1951','1952','1953','1954','1955','1956','1957','1958','1959','1960','1961','1962','1963','1964','1965','1966','1967','1968','1969','1970','1971','1972','1973','1974','1975','1976','1977','1978','1979','1980','1981','1982','1983','1984','1985','1986','1987','1988','1989','1990','1991','1992','1993','1994','1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018','2019','2020','2021') AS "Year last married",
CASE MIG
...
CASE SCHL
    ...
    SEMP::VARCHAR AS "Self-employment income past 12 months (signed, use ADJINC to adjust SEMP to constant dollars)",
CASE SEX
		WHEN '1' THEN 'Male'
		WHEN '2' THEN 'Female'
...
CASE YOEP
		...
		WHEN '2020' THEN '2020'
		WHEN '2021' THEN '2021'
	END::ENUM ('Not applicable - Not eligible - Born in the US','1934 or earlier - Bottom-coded','1935 - 1938','1939 - 1942','1943 - 1944','1945','1946','1947','1948','1949','1950','1951','1952','1953','1954','1955','1956','1957','1958','1959','1960','1961','1962','1963','1964','1965','1966','1967','1968','1969','1970','1971','1972','1973','1974','1975','1976','1977','1978','1979','1980','1981','1982','1983','1984','1985','1986','1987','1988','1989','1990','1991','1992','1993','1994','1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018','2019','2020','2021') AS "Year of entry",
CASE ANC
		WHEN '1' THEN 'Single'
...
CASE INDP
    ...
    MIGPUMA::VARCHAR AS "Migration PUMA based on 2010 Census definition",
CASE MIGSP
...
CASE OCCP
    ...
    PINCP::VARCHAR AS "Total person's income (signed, use ADJINC to adjust to constant dollars)",
CASE POBP
		WHEN '001' THEN 'Alabama or AL'
		WHEN '002' THEN 'Alaska or AK'
		WHEN '004' THEN 'Arizona or AZ'
...
CASE FMIGSP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Migration state allocation flag",
CASE FMILPP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
...
CASE FPINCP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Total person's income (signed) allocation flag",
CASE FPOBP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
...
FROM read_csv('/Users/me/data/american_community_survey/2021/1-Year/csv_pus/psam_pusb.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)