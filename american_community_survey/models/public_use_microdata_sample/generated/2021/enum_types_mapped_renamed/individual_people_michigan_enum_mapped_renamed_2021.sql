...
{{ config(materialized='external', location=var('output_path') + '/acs_pums_individual_people_michigan_2021.parquet') }}
...
FROM read_csv('/Users/me/data/american_community_survey/2021/1-Year/csv_pmi/psam_p26.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)