...
{{ config(materialized='external', location=var('output_path') + '/acs_pums_individual_people_massachusetts_2021.parquet') }}
...
FROM read_csv('/Users/me/data/american_community_survey/2021/1-Year/csv_pma/psam_p25.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)