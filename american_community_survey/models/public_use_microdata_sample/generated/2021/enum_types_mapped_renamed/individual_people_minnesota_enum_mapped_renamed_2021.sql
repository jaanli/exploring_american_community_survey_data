...
{{ config(materialized='external', location=var('output_path') + '/2021_acs_pums_individual_people_minnesota.parquet') }}
...
FROM read_csv('/Users/me/data/american_community_survey/2021/1-Year/csv_pmn/psam_p27.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)