...
{{ config(materialized='external', location=var('output_path') + '/2021_acs_pums_individual_people_georgia.parquet') }}
...
FROM read_csv('/Users/me/data/american_community_survey/2021/1-Year/csv_pga/psam_p13.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)