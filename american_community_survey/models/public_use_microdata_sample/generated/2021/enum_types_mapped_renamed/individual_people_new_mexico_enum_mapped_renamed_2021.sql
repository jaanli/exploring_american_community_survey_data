...
{{ config(materialized='external', location=var('output_path') + '/2021_acs_pums_individual_people_new_mexico.parquet') }}
...
FROM read_csv('/Users/me/data/american_community_survey/2021/1-Year/csv_pnm/psam_p35.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)