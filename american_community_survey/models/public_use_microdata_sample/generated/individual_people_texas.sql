-- SQL transformation for psam_p48.csv generated by generate_sql_data_dictionary_mapping_for_extracted_csv_files.py
{{ config(materialized='external', location=var('output_path') + '/individual_people_texas.parquet') }}
SELECT
    RT AS "Record Type",
...
FROM read_csv_auto('/Users/me/data/american_community_survey/2022/1-Year/csv_ptx/psam_p48.csv')