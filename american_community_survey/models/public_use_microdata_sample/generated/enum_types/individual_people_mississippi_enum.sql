-- SQL transformation for psam_p28 generated by generate_sql_with_enum_types.py
{{ config(materialized='external', location=var('output_path') + '/individual_people_mississippi.parquet') }}
...
CREATE TABLE individual_people_mississippi (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO individual_people_mississippi
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_pms/psam_p28.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)