-- SQL transformation for psam_h27 generated by generate_sql_with_enum_types.py
...
CREATE TABLE housing_units_minnesota (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO housing_units_minnesota
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_hmn/psam_h27.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)