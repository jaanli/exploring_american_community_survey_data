-- SQL transformation for psam_p36 generated by generate_sql_with_enum_types.py
...
CREATE TABLE individual_people_new_york (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO individual_people_new_york
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_pny/psam_p36.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)