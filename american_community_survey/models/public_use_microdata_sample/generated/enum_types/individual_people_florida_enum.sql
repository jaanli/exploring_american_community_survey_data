-- SQL transformation for psam_p12 generated by generate_sql_with_enum_types.py
{{ config(materialized='external', location=var('output_path') + '/individual_people_florida.parquet') }}
...
CREATE TABLE individual_people_florida (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO individual_people_florida
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_pfl/psam_p12.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)