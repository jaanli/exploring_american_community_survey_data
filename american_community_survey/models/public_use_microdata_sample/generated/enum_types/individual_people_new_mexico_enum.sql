-- SQL transformation for psam_p35 generated by generate_sql_with_enum_types.py
{{ config(materialized='external', location=var('output_path') + '/individual_people_new_mexico.parquet') }}
...
CREATE TABLE individual_people_new_mexico (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO individual_people_new_mexico
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_pnm/psam_p35.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)