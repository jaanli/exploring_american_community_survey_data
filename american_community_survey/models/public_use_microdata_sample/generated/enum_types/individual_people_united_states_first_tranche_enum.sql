-- SQL transformation for psam_pusa generated by generate_sql_with_enum_types.py
{{ config(materialized='external', location=var('output_path') + '/individual_people_united_states_first_tranche.parquet') }}
...
CREATE TABLE individual_people_united_states_first_tranche (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO individual_people_united_states_first_tranche
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_pus/psam_pusa.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)