-- SQL transformation for psam_h50 generated by generate_sql_with_enum_types.py
...
CREATE TABLE housing_units_vermont (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO housing_units_vermont
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_hvt/psam_h50.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)