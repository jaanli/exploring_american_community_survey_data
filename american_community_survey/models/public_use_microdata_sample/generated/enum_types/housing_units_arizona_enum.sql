-- SQL transformation for psam_h04 generated by generate_sql_with_enum_types.py
...
CREATE TABLE housing_units_arizona (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO housing_units_arizona
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_haz/psam_h04.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)