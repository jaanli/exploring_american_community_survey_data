-- SQL transformation for psam_h15 generated by generate_sql_with_enum_types.py
...
CREATE TABLE housing_units_hawaii (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO housing_units_hawaii
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_hhi/psam_h15.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)