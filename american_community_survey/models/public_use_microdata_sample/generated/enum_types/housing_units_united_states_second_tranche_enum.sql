-- SQL transformation for psam_husb generated by generate_sql_with_enum_types.py
...
CREATE TABLE housing_units_united_states_second_tranche (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO housing_units_united_states_second_tranche
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_hus/psam_husb.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)