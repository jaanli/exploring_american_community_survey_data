...
CREATE TABLE housing_units_district_of_columbia (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO housing_units_district_of_columbia
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_hdc/psam_h11.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)