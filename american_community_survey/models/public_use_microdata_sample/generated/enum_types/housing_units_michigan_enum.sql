...
CREATE TABLE housing_units_michigan (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO housing_units_michigan
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_hmi/psam_h26.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)