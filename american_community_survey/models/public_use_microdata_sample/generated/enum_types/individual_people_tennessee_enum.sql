...
{{ config(materialized='external', location=var('output_path') + '/individual_people_tennessee.parquet') }}
...
CREATE TABLE individual_people_tennessee (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO individual_people_tennessee
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_ptn/psam_p47.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)