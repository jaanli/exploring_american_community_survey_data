-- SQL transformation for psam_p40 generated by generate_sql_with_enum_types.py
...
CREATE TABLE individual_people_oklahoma (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO individual_people_oklahoma
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_pok/psam_p40.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)