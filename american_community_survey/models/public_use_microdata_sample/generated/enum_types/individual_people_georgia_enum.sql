-- SQL transformation for psam_p13 generated by generate_sql_with_enum_types.py
{{ config(materialized='external', location=var('output_path') + '/individual_people_georgia.parquet') }}
...
CREATE TABLE individual_people_georgia (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO individual_people_georgia
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_pga/psam_p13.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)