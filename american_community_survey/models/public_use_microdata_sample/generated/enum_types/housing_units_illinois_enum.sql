-- SQL transformation for psam_h17 generated by generate_sql_with_enum_types.py
...
CREATE TABLE housing_units_illinois (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO housing_units_illinois
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_hil/psam_h17.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)