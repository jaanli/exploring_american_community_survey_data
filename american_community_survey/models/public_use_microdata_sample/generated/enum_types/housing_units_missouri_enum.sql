-- SQL transformation for psam_h29 generated by generate_sql_with_enum_types.py
...
CREATE TABLE housing_units_missouri (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO housing_units_missouri
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_hmo/psam_h29.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)