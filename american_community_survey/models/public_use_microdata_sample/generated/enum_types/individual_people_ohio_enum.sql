-- SQL transformation for psam_p39 generated by generate_sql_with_enum_types.py
{{ config(materialized='external', location=var('output_path') + '/individual_people_ohio.parquet') }}
...
CREATE TABLE individual_people_ohio (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO individual_people_ohio
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_poh/psam_p39.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)