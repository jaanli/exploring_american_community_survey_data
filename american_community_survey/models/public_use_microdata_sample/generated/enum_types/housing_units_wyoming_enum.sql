-- SQL transformation for psam_h56 generated by generate_sql_with_enum_types.py
...
CREATE TABLE housing_units_wyoming (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO housing_units_wyoming
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_hwy/psam_h56.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)