-- SQL transformation for psam_p18 generated by generate_sql_with_enum_types.py
{{ config(materialized='external', location=var('output_path') + '/individual_people_indiana.parquet') }}
...
CREATE TABLE individual_people_indiana (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO individual_people_indiana
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_pin/psam_p18.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)