...
{{ config(materialized='external', location=var('output_path') + '/individual_people_louisiana.parquet') }}
...
CREATE TABLE individual_people_louisiana (
    RT RT_enum,
    SERIALNO VARCHAR,
...
INSERT INTO individual_people_louisiana
SELECT * FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_pla/psam_p22.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)