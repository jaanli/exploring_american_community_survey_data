-- SQL transformation for psam_pusb generated by generate_sql_with_enum_types_and_mapped_values_renamed.py
{{ config(materialized='external', location=var('output_path') + '/individual_people_united_states_second_tranche_enum_types_mapped_renamed.parquet') }}
...
CASE DIVISION
	...
	END::ENUM ('Puerto Rico','New England - Northeast region','Middle Atlantic - Northeast region','East North Central - Midwest region','West North Central - Midwest region','South Atlantic - South region','East South Central - South region','West South Central - South Region','Mountain - West region','Pacific - West region') AS "Division code based on 2010 Census definitions Division code based on 2020 Census definitions",
    PUMA::VARCHAR AS "Public use microdata area code (PUMA) based on 2020 Census definition (areas with population of 100,000 or more, use with ST for unique code)",
CASE REGION
	...
	END::ENUM ('Northeast','Midwest','South','West','Puerto Rico') AS "Region code based on 2020 Census definitions",
CASE ST
...
CASE CIT
	...
	END::ENUM ('Born in the United States','Born in Puerto Rico, Guam, the U.S. Virgin Islands, or Northern Marianas','Born abroad of U.S. citizen parent or parents','U.S. citizen by naturalization','Not a U.S. citizen') AS "Citizenship status",
CASE CITWP
		...
		WHEN '2021' THEN '2021'
		WHEN '2022' THEN '2022'
	END::ENUM ('Not applicable - Not eligible - not naturalized','1947 or earlier - Bottom-coded','1948 - 1949','1950 - 1951','1952','1953','1954','1955','1956','1957','1958','1959','1960','1961','1962','1963','1964','1965','1966','1967','1968','1969','1970','1971','1972','1973','1974','1975','1976','1977','1978','1979','1980','1981','1982','1983','1984','1985','1986','1987','1988','1989','1990','1991','1992','1993','1994','1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018','2019','2020','2021','2022') AS "Year of naturalization write-in",
CASE COW
...
CASE ENG
	...
	END::ENUM ('Not applicable - less than 5 years old or speaks only English','Very well','Well','Not well','Not at all') AS "Ability to speak English",
CASE FER
		WHEN 'b' THEN 'Not applicable - less than 15 years or greater than 50 years or  male'
		WHEN '1' THEN 'Yes'
		WHEN '2' THEN 'No'
	END::ENUM ('Not applicable - less than 15 years or greater than 50 years or  male','Yes','No') AS "Gave birth to child within the past 12 months",
    GCL::VARCHAR AS "Grandparents living with grandchildren",
    GCM::VARCHAR AS "Length of time responsible for grandchildren",
    GCR::VARCHAR AS "Grandparents responsible for grandchildren",
    HIMRKS::VARCHAR AS "Subsidized Marketplace Coverage",
    HINS1::VARCHAR AS "Insurance through a current or former employer or union",
CASE HINS2
		WHEN '1' THEN 'Yes'
		WHEN '2' THEN 'No'
	END::ENUM ('Yes','No') AS "Insurance purchased directly from an insurance company",
CASE HINS3
		WHEN '1' THEN 'Yes'
		WHEN '2' THEN 'No'
	END::ENUM ('Yes','No') AS "Medicare, for people 65 and older, or people with certain disabilities",
    HINS4::VARCHAR AS "Medicaid, Medical Assistance, or any kind of government-assistance plan for those with low incomes or a disability",
CASE HINS5
		WHEN '1' THEN 'Yes'
		WHEN '2' THEN 'No'
	END::ENUM ('Yes','No') AS "TRICARE or other military health care",
CASE HINS6
		WHEN '1' THEN 'Yes'
		WHEN '2' THEN 'No'
	END::ENUM ('Yes','No') AS "VA (enrolled for VA health care)",
CASE HINS7
		WHEN '1' THEN 'Yes'
		WHEN '2' THEN 'No'
	END::ENUM ('Yes','No') AS "Indian Health Service",
    INTP::VARCHAR AS "Interest, dividends, and net rental income past 12 months (use ADJINC to adjust to constant dollars)",
    JWMNP::VARCHAR AS "Travel time to work",
CASE JWRIP
	...
	END::ENUM ('Not applicable - not a worker or worker whose means of transportation to work was not car, truck, or van','Drove alone','In 2-person carpool','In 3-person carpool','In 4-person carpool','In 5-person carpool','In 6-person carpool','In 7-person carpool','In 8-person carpool','In 9-person carpool','In 10-person or more carpool - Top-coded') AS "Vehicle occupancy",
CASE JWTRNS
...
CASE MAR
	...
	END::ENUM ('Married','Widowed','Divorced','Separated','Never married or under 15 years old') AS "Marital status",
CASE MARHD
		WHEN 'b' THEN 'Not applicable - age less than 15 years; never married'
		WHEN '1' THEN 'Yes'
		WHEN '2' THEN 'No'
	END::ENUM ('Not applicable - age less than 15 years; never married','Yes','No') AS "Divorced in the past 12 months",
CASE MARHM
		WHEN 'b' THEN 'Not applicable - age less than 15 years; never married'
		WHEN '1' THEN 'Yes'
		WHEN '2' THEN 'No'
	END::ENUM ('Not applicable - age less than 15 years; never married','Yes','No') AS "Married in the past 12 months",
    MARHT::VARCHAR AS "Number of times married",
CASE MARHW
		WHEN 'b' THEN 'Not applicable - age less than 15 years; never married'
		WHEN '1' THEN 'Yes'
		WHEN '2' THEN 'No'
	END::ENUM ('Not applicable - age less than 15 years; never married','Yes','No') AS "Widowed in the past 12 months",
CASE MARHYP
		...
		WHEN '2021' THEN '2021'
		WHEN '2022' THEN '2022'
	END::ENUM ('Not applicable - age less than 15 years; never married','1943 or earlier - Bottom-coded','1944','1945','1946','1947','1948','1949','1950','1951','1952','1953','1954','1955','1956','1957','1958','1959','1960','1961','1962','1963','1964','1965','1966','1967','1968','1969','1970','1971','1972','1973','1974','1975','1976','1977','1978','1979','1980','1981','1982','1983','1984','1985','1986','1987','1988','1989','1990','1991','1992','1993','1994','1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018','2019','2020','2021','2022') AS "Year last married",
CASE MIG
	...
	END::ENUM ('Not applicable - less than 1 year old','Yes, same house - nonmovers','No, outside US and Puerto Rico','No, different house in US or Puerto Rico') AS "Mobility status (lived here 1 year ago)",
CASE MIL
	...
	END::ENUM ('Not applicable - less than 17 years old','Now on active duty','On active duty in the past, but not now','Only on active duty for training in Reserves or National Guard','Never served in the military') AS "Military service",
CASE MLPA
	...
	END::ENUM ('Not applicable - less than 17 years old or no active duty','Did not serve this period','Served this period') AS "Served September 2001 or later",
CASE MLPB
		WHEN 'b' THEN 'Not applicable - less than 17 years old or no active duty'
		WHEN '0' THEN 'Did not serve this period'
		WHEN '1' THEN 'Served this period'
	END::ENUM ('Not applicable - less than 17 years old or no active duty','Did not serve this period','Served this period') AS "Served August 1990 - August 2001 (including Persian Gulf War)",
CASE MLPCD
		WHEN 'b' THEN 'Not applicable - less than 17 years old or no active duty'
		WHEN '0' THEN 'Did not serve this period'
		WHEN '1' THEN 'Served this period'
	END::ENUM ('Not applicable - less than 17 years old or no active duty','Did not serve this period','Served this period') AS "Served May 1975 - July 1990",
CASE MLPE
		WHEN 'b' THEN 'Not applicable - less than 17 years old or no active duty'
		WHEN '0' THEN 'Did not serve this period'
		WHEN '1' THEN 'Served this period'
	END::ENUM ('Not applicable - less than 17 years old or no active duty','Did not serve this period','Served this period') AS "Served Vietnam era (August 1964 - April 1975)",
CASE MLPFG
		WHEN 'b' THEN 'Not applicable - less than 17 years old or no active duty'
		WHEN '0' THEN 'Did not serve this period'
		WHEN '1' THEN 'Served this period'
	END::ENUM ('Not applicable - less than 17 years old or no active duty','Did not serve this period','Served this period') AS "Served February 1955 - July 1964",
CASE MLPH
		WHEN 'b' THEN 'Not applicable - less than 17 years old or no active duty'
		WHEN '0' THEN 'Did not serve this period'
		WHEN '1' THEN 'Served this period'
	END::ENUM ('Not applicable - less than 17 years old or no active duty','Did not serve this period','Served this period') AS "Served Korean War (July 1950 - January 1955)",
    MLPIK::VARCHAR AS "Peacetime service before July 1950",
CASE MLPJ
		WHEN 'b' THEN 'Not applicable - less than 17 years old or no active duty'
		WHEN '0' THEN 'Did not serve this period'
		WHEN '1' THEN 'Served this period'
	END::ENUM ('Not applicable - less than 17 years old or no active duty','Did not serve this period','Served this period') AS "Served World War II (December 1941 - December 1946)",
CASE NWAB
		WHEN 'b' THEN 'Not applicable - less than 16 years old or at work or on layoff'
		WHEN '1' THEN 'Yes'
		WHEN '2' THEN 'No'
		WHEN '3' THEN 'Did not report'
	END::ENUM ('Not applicable - less than 16 years old or at work or on layoff','Yes','No','Did not report') AS "Temporary absence from work (UNEDITED - See 'Employment Status Recode' (ESR))",
CASE NWAV
	...
	END::ENUM ('Not applicable - less than 16 years or at work or not looking','Yes','No, temporarily ill','No, other reasons','No, unspecified','Did not report') AS "Available for work (UNEDITED - See 'Employment Status Recode' (ESR))",
CASE NWLA
		WHEN 'b' THEN 'Not applicable - less than 16 years old or at work'
		WHEN '1' THEN 'Yes'
		WHEN '2' THEN 'No'
		WHEN '3' THEN 'Did not report'
	END::ENUM ('Not applicable - less than 16 years old or at work','Yes','No','Did not report') AS "On layoff from work (UNEDITED - See 'Employment Status Recode' (ESR))",
CASE NWLK
		WHEN 'b' THEN 'Not applicable - less than 16 years old or at work or temporarily absent or informed of recall'
		WHEN '1' THEN 'Yes'
		WHEN '2' THEN 'No'
		WHEN '3' THEN 'Did not report'
	END::ENUM ('Not applicable - less than 16 years old or at work or temporarily absent or informed of recall','Yes','No','Did not report') AS "Looking for work (UNEDITED - See 'Employment Status Recode' (ESR))",
CASE NWRE
		WHEN 'b' THEN 'Not applicable - less than 16 years old or at work or not on layoff'
		WHEN '1' THEN 'Yes'
		WHEN '2' THEN 'No'
		WHEN '3' THEN 'Did not report'
	END::ENUM ('Not applicable - less than 16 years old or at work or not on layoff','Yes','No','Did not report') AS "Informed of recall (UNEDITED - See 'Employment Status Recode' (ESR))",
    OIP::VARCHAR AS "All other income past 12 months (use ADJINC to adjust to constant dollars)",
    PAP::VARCHAR AS "Public assistance income past 12 months (use ADJINC to adjust to constant dollars)",
CASE RELSHIPP
...
CASE SCH
	...
	END::ENUM ('Not applicable - less than 3 years old','No, has not attended in the last 3 months','Yes, public school or public college','Yes, private school or college or home school') AS "School enrollment",
CASE SCHG
	...
	END::ENUM ('Not applicable - not attending school','Nursery school or preschool','Kindergarten','Grade 1','Grade 2','Grade 3','Grade 4','Grade 5','Grade 6','Grade 7','Grade 8','Grade 9','Grade 10','Grade 11','Grade 12','College undergraduate years - freshman to senior','Graduate or professional school beyond a bachelors degree') AS "Grade level attending",
CASE SCHL
	...
	END::ENUM ('Not applicable - less than 3 years old','No schooling completed','Nursery school, preschool','Kindergarten','Grade 1','Grade 2','Grade 3','Grade 4','Grade 5','Grade 6','Grade 7','Grade 8','Grade 9','Grade 10','Grade 11','12th grade - no diploma','Regular high school diploma','GED or alternative credential','Some college, but less than 1 year','1 or more years of college credit, no degree','Associates degree','Bachelors degree','Masters degree','Professional degree beyond a bachelors degree','Doctorate degree') AS "Educational attainment",
    SEMP::VARCHAR AS "Self-employment income past 12 months (use ADJINC to adjust SEMP to constant dollars)",
CASE SEX
		WHEN '1' THEN 'Male'
		WHEN '2' THEN 'Female'
	END::ENUM ('Male','Female') AS "Sex",
    SSIP::VARCHAR AS "Supplementary Security Income past 12 months (use ADJINC to adjust SSIP to constant dollars)",
    SSP::VARCHAR AS "Social Security income past 12 months (use ADJINC to adjust SSP to constant dollars)",
    WAGP::VARCHAR AS "Wages or salary income past 12 months (use ADJINC to adjust WAGP to constant dollars)",
    WKHP::VARCHAR AS "Usual hours worked per week past 12 months",
CASE WKL
	...
	END::ENUM ('Not applicable - less than 16 years old','Within the past 12 months','1-5 years ago','Over 5 years ago or never worked') AS "When last worked",
    WKWN::VARCHAR AS "Weeks worked during past 12 months",
CASE WRK
		WHEN 'b' THEN 'Not applicable - not reported'
		WHEN '1' THEN 'Worked'
		WHEN '2' THEN 'Did not work'
	END::ENUM ('Not applicable - not reported','Worked','Did not work') AS "Worked last week",
CASE YOEP
		...
		WHEN '2021' THEN '2021'
		WHEN '2022' THEN '2022'
	END::ENUM ('Not applicable - Not eligible - Born in the US','1934 or earlier - Bottom-coded','1935 - 1938','1939 - 1942','1943 - 1944','1945','1946','1947','1948','1949','1950','1951','1952','1953','1954','1955','1956','1957','1958','1959','1960','1961','1962','1963','1964','1965','1966','1967','1968','1969','1970','1971','1972','1973','1974','1975','1976','1977','1978','1979','1980','1981','1982','1983','1984','1985','1986','1987','1988','1989','1990','1991','1992','1993','1994','1995','1996','1997','1998','1999','2000','2001','2002','2003','2004','2005','2006','2007','2008','2009','2010','2011','2012','2013','2014','2015','2016','2017','2018','2019','2020','2021','2022') AS "Year of entry",
CASE ANC
		WHEN '1' THEN 'Single'
		WHEN '2' THEN 'Multiple'
		WHEN '3' THEN 'Unclassified'
		WHEN '4' THEN 'Not reported'
	END::ENUM ('Single','Multiple','Unclassified','Not reported') AS "Ancestry recode",
CASE ANC1P
...
CASE ANC2P
		...
		WHEN '998' THEN 'Other responses'
		WHEN '999' THEN 'Not reported'
	END::ENUM ('Alsatian','Austrian','Basque','Belgian','Flemish','British','British Isles','Danish','Dutch','English','Finnish','French','German','Prussian','Greek','Icelander','Irish','Italian','Sicilian','Luxembourger','Maltese','Norwegian','Portuguese','Scotch Irish','Scottish','Swedish','Swiss','Irish Scotch','Welsh','Scandinavian','Celtic','Albanian','Belorussian','Bulgarian','Croatian','Czech','Bohemian','Czechoslovakian','Estonian','German Russian','Rom','Hungarian','Latvian','Lithuanian','Macedonian','Montenegrin','Polish','Romanian','Moldavian','Russian','Serbian','Slovak','Slovene','Turkestani','Uzbeg','Georgia CIS','Ukrainian','Yugoslavian','Bosnian and Herzegovinian','Slavic','Central European','Northern European','Southern European','Western European','Eastern European','Germanic','European','Spaniard','Mexican','Mexican American','Mexicano','Chicano','Mexican American Indian','Mexican State','Mexican Indian','Costa Rican','Guatemalan','Honduran','Nicaraguan','Panamanian','Salvadoran','Central American','Argentinean','Bolivian','Chilean','Colombian','Ecuadorian','Paraguayan','Peruvian','Uruguayan','Venezuelan','South American','Latin American','Latin','Latino','Puerto Rican','Cuban','Dominican','Hispanic','Spanish','Spanish American','Bahamian','Barbadian','Belizean','Jamaican','Dutch West Indian','Trinidadian Tobagonian','British West Indian','Antigua and Barbuda','Grenadian','Vincent-Grenadine Islander','St Lucia Islander','West Indian','Haitian','Other West Indian','Brazilian','Guyanese','Algerian','Egyptian','Libyan','Moroccan','North African','Iranian','Iraqi','Israeli','Jordanian','Lebanese','Saudi Arabian','Syrian','Armenian','Turkish','Yemeni','Kurdish','Palestinian','Assyrian','Chaldean','Mideast','Arab','Arabic','Other Arab','Cameroonian','Cape Verdean','Congolese','Ethiopian','Eritrean','Gambian','Ghanaian','Guinean','Kenyan','Liberian','Nigerian','Senegalese','Sierra Leonean','Somali','South African','Sudanese','Togo','Other Subsaharan African','Ugandan','Zimbabwean','Western African','African','Afghan','Bangladeshi','Bhutanese','Nepali','Asian Indian','Bengali','East Indian','Punjabi','Pakistani','Sri Lankan','Burmese','Cambodian','Chinese','Cantonese','Mongolian','Tibetan','Hong Kong','Filipino','Indonesian','Japanese','Okinawan','Korean','Laotian','Hmong','Malaysian','Thai','Taiwanese','Vietnamese','Asian','Other Asian','Australian','New Zealander','Polynesian','Hawaiian','Samoan','Tongan','Micronesian','Guamanian','Chamorro','Marshallese','Fijian','Pacific Islander','Other Pacific','Afro American','Afro','African American','Black','Negro','Creole','Central American Indian','South American Indian','Native American','Indian','Cherokee','American Indian','Eskimo','White','Anglo','Appalachian','Pennsylvania German','Canadian','French Canadian','Cajun','American','United States','Texas','North American','Mixture','Uncodable entries','Other groups','Other responses','Not reported') AS "Recoded Detailed Ancestry - second entry",
CASE DECADE
	...
	END::ENUM ('Not applicable - Born in the US','Before 1950','1950 - 1959','1960 - 1969','1970 - 1979','1980 - 1989','1990 - 1999','2000 - 2009','2010 or later') AS "Decade of entry",
CASE DIS
		WHEN '1' THEN 'With a disability'
		WHEN '2' THEN 'Without a disability'
	END::ENUM ('With a disability','Without a disability') AS "Disability recode",
    DRIVESP::VARCHAR AS "Number of vehicles calculated from JWRI",
    ESP::VARCHAR AS "Employment status of parents",
CASE ESR
		WHEN 'b' THEN 'Not applicable - less than 16 years old'
	...
	END::ENUM ('Not applicable - less than 16 years old','Civilian employed, at work','Civilian employed, with a job but not at work','Unemployed','Armed forces, at work','Armed forces, with a job but not at work','Not in labor force') AS "Employment status recode",
CASE FOD1P
...
CASE FOD2P
		...
		WHEN '6402' THEN 'History'
		WHEN '6403' THEN 'United States History'
	END::ENUM ('Not applicable - less than bachelors degree','General Agriculture','Agriculture Production And Management','Agricultural Economics','Animal Sciences','Food Science','Plant Science And Agronomy','Soil Science','Miscellaneous Agriculture','Environmental Science','Forestry','Natural Resources Management','Architecture','Area Ethnic And Civilization Studies','Communications','Journalism','Mass Media','Advertising And Public Relations','Communication Technologies','Computer And Information Systems','Computer Programming And Data Processing','Computer Science','Information Sciences','Computer Administration Management And Security','Computer Networking And Telecommunications','Cosmetology Services And Culinary Arts','General Education','Educational Administration And Supervision','School Student Counseling','Elementary Education','Mathematics Teacher Education','Physical And Health Education Teaching','Early Childhood Education','Science And Computer Teacher Education','Secondary Teacher Education','Special Needs Education','Social Science Or History Teacher Education','Teacher Education: Multiple Levels','Language And Drama Education','Art And Music Education','Miscellaneous Education','General Engineering','Aerospace Engineering','Biological Engineering','Architectural Engineering','Biomedical Engineering','Chemical Engineering','Civil Engineering','Computer Engineering','Electrical Engineering','Engineering Mechanics Physics And Science','Environmental Engineering','Geological And Geophysical Engineering','Industrial And Manufacturing Engineering','Materials Engineering And Materials Science','Mechanical Engineering','Metallurgical Engineering','Mining And Mineral Engineering','Naval Architecture And Marine Engineering','Nuclear Engineering','Petroleum Engineering','Miscellaneous Engineering','Engineering Technologies','Engineering And Industrial Management','Electrical Engineering Technology','Industrial Production Technologies','Mechanical Engineering Related Technologies','Miscellaneous Engineering Technologies','Linguistics And Comparative Language And Literature','French German Latin And Other Common Foreign Language Studies','Other Foreign Languages','Family And Consumer Sciences','Pre-Law And Legal Studies','English Language And Literature','Composition And Rhetoric','Liberal Arts','Humanities','Library Science','Biology','Biochemical Sciences','Botany','Molecular Biology','Ecology','Genetics','Microbiology','Pharmacology','Physiology','Zoology','Neuroscience','Miscellaneous Biology','Mathematics','Applied Mathematics','Statistics And Decision Science','Military Technologies','Multi or Interdisciplinary Studies','Intercultural And International Studies','Nutrition Sciences','Mathematics And Computer Science','Cognitive Science And Biopsychology','Interdisciplinary Social Sciences','Physical Fitness Parks Recreation And Leisure','Philosophy And Religious Studies','Theology And Religious Vocations','Physical Sciences','Astronomy And Astrophysics','Atmospheric Sciences And Meteorology','Chemistry','Geology And Earth Science','Geosciences','Oceanography','Physics','Materials Science','Multi-Disciplinary Or General Science','Nuclear, Industrial Radiology, And Biological Technologies','Psychology','Educational Psychology','Clinical Psychology','Counseling Psychology','Industrial And Organizational Psychology','Social Psychology','Miscellaneous Psychology','Criminal Justice And Fire Protection','Public Administration','Public Policy','Human Services And Community Organization','Social Work','General Social Sciences','Economics','Anthropology And Archeology','Criminology','Geography','International Relations','Political Science And Government','Sociology','Miscellaneous Social Sciences','Construction Services','Electrical, Mechanical, And Precision Technologies And Production','Transportation Sciences And Technologies','Fine Arts','Drama And Theater Arts','Music','Visual And Performing Arts','Commercial Art And Graphic Design','Film Video And Photographic Arts','Art History And Criticism','Studio Arts','Miscellaneous Fine Arts','General Medical And Health Services','Communication Disorders Sciences And Services','Health And Medical Administrative Services','Medical Assisting Services','Medical Technologies Technicians','Health And Medical Preparatory Programs','Nursing','Pharmacy Pharmaceutical Sciences And Administration','Treatment Therapy Professions','Community And Public Health','Miscellaneous Health Medical Professions','General Business','Accounting','Actuarial Science','Business Management And Administration','Operations Logistics And E-Commerce','Business Economics','Marketing And Marketing Research','Finance','Human Resources And Personnel Management','International Business','Hospitality Management','Management Information Systems And Statistics','Miscellaneous Business And Medical Administration','History','United States History') AS "Recoded field of degree - second entry",
    HICOV::VARCHAR AS "Health insurance coverage recode",
CASE HISP
...
CASE MSP
	...
	END::ENUM ('Not applicable - age less than 15 years','Now married, spouse present','Now married, spouse absent','Widowed','Divorced','Separated','Never married') AS "Married, spouse present/spouse absent",
CASE NAICSP
...
CASE POWSP
	...
	END::ENUM ('Not applicable - not a worker-not in the labor force, including persons under 16 years; unemployed; employed, with a job not at work; Armed Forces, with a job but not at work','Alabama or AL','Alaska or AK','Arizona or AZ','Arkansas or AR','California or CA','Colorado or CO','Connecticut or CT','Delaware or DE','District of Columbia or DC','Florida or FL','Georgia or GA','Hawaii or HI','Idaho or ID','Illinois or IL','Indiana or IN','Iowa or IA','Kansas or KS','Kentucky or KY','Louisiana or LA','Maine or ME','Maryland or MD','Massachusetts or MA','Michigan or MI','Minnesota or MN','Mississippi or MS','Missouri or MO','Montana or MT','Nebraska or NE','Nevada or NV','New Hampshire or NH','New Jersey or NJ','New Mexico or NM','New York or NY','North Carolina or NC','North Dakota or ND','Ohio or OH','Oklahoma or OK','Oregon or OR','Pennsylvania or PA','Rhode Island or RI','South Carolina or SC','South Dakota or SD','Tennessee or TN','Texas or TX','Utah or UT','Vermont or VT','Virginia or VA','Washington or WA','West Virginia or WV','Wisconsin or WI','Wyoming or WY','Puerto Rico','Europe','Asia','Mexico','Americas, Not Specified','Other US Island Areas Not Specified, Africa, Oceania, at Sea, or Abroad, Not Specified') AS "Place of work - State or foreign country recode",
    PRIVCOV::VARCHAR AS "Private health insurance coverage recode",
    PUBCOV::VARCHAR AS "Public health coverage recode",
CASE QTRBIR
	...
	END::ENUM ('January through March','April through June','July through September','October through December') AS "Quarter of birth",
CASE RAC1P
	...
	END::ENUM ('White alone','Black or African American alone','American Indian alone','Alaska Native alone','American Indian and Alaska Native tribes specified; or American Indian or Alaska Native, not specified and no other races','Asian alone','Native Hawaiian and Other Pacific Islander alone','Some Other Race alone','Two or More Races') AS "Recoded detailed race code",
CASE RAC2P
...
CASE SFR
	...
	END::ENUM ('Not applicable - GQ or not in a subfamily','Husband or wife no children','Husband or wife with children','Parent in a one-parent subfamily','Child in a married-couple subfamily','Child in a mother-child subfamily','Child in a father-child subfamily') AS "Subfamily relationship",
CASE SOCP
...
CASE WAOB
	...
	END::ENUM ('US state - POBP = 001-059','PR and US Island Areas - POBP = 061-099','Latin America - POBP = 303,310-399','Asia - POBP = 158-159,161,200-299','Europe - POBP = 100-157,160,162-199','Africa - POBP = 400-499','Northern America - POBP = 300-302,304-309','Oceania and at Sea - POBP = 060,500-554') AS "World area of birth",
CASE FAGEP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Age allocation flag",
CASE FANCP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Ancestry allocation flag",
CASE FCITP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Citizenship allocation flag",
CASE FCITWP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Year of naturalization write-in allocation flag",
CASE FCOWP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Class of worker allocation flag",
CASE FDDRSP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Self-care difficulty allocation flag",
CASE FDEARP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Hearing difficulty allocation flag",
CASE FDEYEP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Vision difficulty allocation flag",
CASE FDISP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Disability recode allocation flag",
CASE FDOUTP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Independent living difficulty allocation flag",
CASE FDPHYP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Ambulatory difficulty allocation flag",
CASE FDRATP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Disability rating percentage allocation flag",
CASE FDRATXP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Disability rating checkbox allocation flag",
CASE FDREMP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Cognitive difficulty allocation flag",
CASE FENGP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Ability to speak English allocation flag",
CASE FESRP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Employment status recode allocation flag",
CASE FFERP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Gave birth to child within the past 12 months allocation flag",
CASE FFODP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Field of Degree allocation flag",
CASE FGCLP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Grandparents living with grandchildren allocation flag",
CASE FGCMP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Length of time responsible for grandchildren allocation flag",
CASE FGCRP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Grandparents responsible for grandchildren allocation flag",
CASE FHICOVP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Health insurance coverage recode allocation flag",
CASE FHIMRKSP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Subsidized Marketplace Coverage allocation flag",
CASE FHINS1P
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Insurance through a current or former employer or union allocation flag",
CASE FHINS2P
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Insurance purchased directly from an insurance company allocation flag",
    FHINS3C::VARCHAR AS "Medicare coverage given through the eligibility coverage edit",
CASE FHINS3P
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Medicare, for people 65 or older, or people with certain disabilities allocation flag",
    FHINS4C::VARCHAR AS "Medicaid coverage given through the eligibility coverage edit",
CASE FHINS4P
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Medicaid, medical assistance, or any kind of government-assistance plan for people with low incomes or a disability allocation flag",
    FHINS5C::VARCHAR AS "TRICARE coverage given through the eligibility coverage edit",
CASE FHINS5P
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "TRICARE or other military health care allocation flag",
CASE FHINS6P
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "VA (enrolled for VA health care) allocation flag",
CASE FHINS7P
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Indian health service allocation flag",
CASE FHISP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Detailed Hispanic origin allocation flag",
CASE FINDP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Industry allocation flag",
CASE FINTP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Interest, dividend, and net rental income allocation flag",
CASE FJWDP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Time of departure to work allocation flag",
CASE FJWMNP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Travel time to work allocation flag",
CASE FJWRIP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Vehicle occupancy allocation flag",
CASE FJWTRNSP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Means of transportation to work allocation flag",
CASE FLANP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Language spoken at home allocation flag",
CASE FLANXP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Language other than English allocation flag",
CASE FMARP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Marital status allocation flag",
CASE FMARHDP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Divorced in the past 12 months allocation flag",
CASE FMARHMP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Married in the past 12 months allocation flag",
CASE FMARHTP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Times married allocation flag",
CASE FMARHWP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Widowed in the past 12 months allocation flag",
CASE FMARHYP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Year last married allocation flag",
CASE FMIGP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Mobility status allocation flag",
CASE FMIGSP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Migration state and foreign country allocation flag",
CASE FMILPP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Military periods of service allocation flag",
CASE FMILSP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Military service allocation flag",
CASE FOCCP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Occupation allocation flag",
CASE FOIP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "All other income allocation flag",
CASE FPAP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Public assistance income allocation flag",
CASE FPERNP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Total person's earnings allocation flag",
CASE FPINCP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Total person's income allocation flag",
CASE FPOBP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Place of birth allocation flag",
CASE FPOWSP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Place of work state allocation flag",
CASE FPRIVCOVP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Private health insurance coverage recode allocation flag",
CASE FPUBCOVP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Public health coverage recode allocation flag",
CASE FRACP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Detailed race allocation flag",
CASE FRELSHIPP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Relationship allocation flag",
CASE FRETP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Retirement income allocation flag",
CASE FSCHGP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Grade attending allocation flag",
CASE FSCHLP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Highest education allocation flag",
CASE FSCHP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "School enrollment allocation flag",
CASE FSEMP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Self-employment income allocation flag",
CASE FSEXP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Sex allocation flag",
CASE FSSIP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Supplementary Security Income allocation flag",
CASE FSSP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Social Security income allocation flag",
CASE FWAGP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Wages and salary income allocation flag",
CASE FWKHP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Usual hours worked per week past 12 months allocation flag",
CASE FWKLP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Last worked allocation flag",
CASE FWKWNP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Weeks worked past 12 months allocation flag",
CASE FWRKP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Worked last week allocation flag",
CASE FYOEP
		WHEN '0' THEN 'No'
		WHEN '1' THEN 'Yes'
	END::ENUM ('No','Yes') AS "Year of entry allocation flag",
    PWGTP1::VARCHAR AS "Person's Weight replicate 1",
    PWGTP2::VARCHAR AS "Person's Weight replicate 2",
    PWGTP3::VARCHAR AS "Person's Weight replicate 3",
    PWGTP4::VARCHAR AS "Person's Weight replicate 4",
    PWGTP5::VARCHAR AS "Person's Weight replicate 5",
    PWGTP6::VARCHAR AS "Person's Weight replicate 6",
    PWGTP7::VARCHAR AS "Person's Weight replicate 7",
    PWGTP8::VARCHAR AS "Person's Weight replicate 8",
    PWGTP9::VARCHAR AS "Person's Weight replicate 9",
    PWGTP10::VARCHAR AS "Person's Weight replicate 10",
    PWGTP11::VARCHAR AS "Person's Weight replicate 11",
    PWGTP12::VARCHAR AS "Person's Weight replicate 12",
    PWGTP13::VARCHAR AS "Person's Weight replicate 13",
    PWGTP14::VARCHAR AS "Person's Weight replicate 14",
    PWGTP15::VARCHAR AS "Person's Weight replicate 15",
    PWGTP16::VARCHAR AS "Person's Weight replicate 16",
    PWGTP17::VARCHAR AS "Person's Weight replicate 17",
    PWGTP18::VARCHAR AS "Person's Weight replicate 18",
    PWGTP19::VARCHAR AS "Person's Weight replicate 19",
    PWGTP20::VARCHAR AS "Person's Weight replicate 20",
    PWGTP21::VARCHAR AS "Person's Weight replicate 21",
    PWGTP22::VARCHAR AS "Person's Weight replicate 22",
    PWGTP23::VARCHAR AS "Person's Weight replicate 23",
    PWGTP24::VARCHAR AS "Person's Weight replicate 24",
    PWGTP25::VARCHAR AS "Person's Weight replicate 25",
    PWGTP26::VARCHAR AS "Person's Weight replicate 26",
    PWGTP27::VARCHAR AS "Person's Weight replicate 27",
    PWGTP28::VARCHAR AS "Person's Weight replicate 28",
    PWGTP29::VARCHAR AS "Person's Weight replicate 29",
    PWGTP30::VARCHAR AS "Person's Weight replicate 30",
    PWGTP31::VARCHAR AS "Person's Weight replicate 31",
    PWGTP32::VARCHAR AS "Person's Weight replicate 32",
    PWGTP33::VARCHAR AS "Person's Weight replicate 33",
    PWGTP34::VARCHAR AS "Person's Weight replicate 34",
    PWGTP35::VARCHAR AS "Person's Weight replicate 35",
    PWGTP36::VARCHAR AS "Person's Weight replicate 36",
    PWGTP37::VARCHAR AS "Person's Weight replicate 37",
    PWGTP38::VARCHAR AS "Person's Weight replicate 38",
    PWGTP39::VARCHAR AS "Person's Weight replicate 39",
    PWGTP40::VARCHAR AS "Person's Weight replicate 40",
    PWGTP41::VARCHAR AS "Person's Weight replicate 41",
    PWGTP42::VARCHAR AS "Person's Weight replicate 42",
    PWGTP43::VARCHAR AS "Person's Weight replicate 43",
    PWGTP44::VARCHAR AS "Person's Weight replicate 44",
    PWGTP45::VARCHAR AS "Person's Weight replicate 45",
    PWGTP46::VARCHAR AS "Person's Weight replicate 46",
    PWGTP47::VARCHAR AS "Person's Weight replicate 47",
    PWGTP48::VARCHAR AS "Person's Weight replicate 48",
    PWGTP49::VARCHAR AS "Person's Weight replicate 49",
    PWGTP50::VARCHAR AS "Person's Weight replicate 50",
    PWGTP51::VARCHAR AS "Person's Weight replicate 51",
    PWGTP52::VARCHAR AS "Person's Weight replicate 52",
    PWGTP53::VARCHAR AS "Person's Weight replicate 53",
    PWGTP54::VARCHAR AS "Person's Weight replicate 54",
    PWGTP55::VARCHAR AS "Person's Weight replicate 55",
    PWGTP56::VARCHAR AS "Person's Weight replicate 56",
    PWGTP57::VARCHAR AS "Person's Weight replicate 57",
    PWGTP58::VARCHAR AS "Person's Weight replicate 58",
    PWGTP59::VARCHAR AS "Person's Weight replicate 59",
    PWGTP60::VARCHAR AS "Person's Weight replicate 60",
    PWGTP61::VARCHAR AS "Person's Weight replicate 61",
    PWGTP62::VARCHAR AS "Person's Weight replicate 62",
    PWGTP63::VARCHAR AS "Person's Weight replicate 63",
    PWGTP64::VARCHAR AS "Person's Weight replicate 64",
    PWGTP65::VARCHAR AS "Person's Weight replicate 65",
    PWGTP66::VARCHAR AS "Person's Weight replicate 66",
    PWGTP67::VARCHAR AS "Person's Weight replicate 67",
    PWGTP68::VARCHAR AS "Person's Weight replicate 68",
    PWGTP69::VARCHAR AS "Person's Weight replicate 69",
    PWGTP70::VARCHAR AS "Person's Weight replicate 70",
    PWGTP71::VARCHAR AS "Person's Weight replicate 71",
    PWGTP72::VARCHAR AS "Person's Weight replicate 72",
    PWGTP73::VARCHAR AS "Person's Weight replicate 73",
    PWGTP74::VARCHAR AS "Person's Weight replicate 74",
    PWGTP75::VARCHAR AS "Person's Weight replicate 75",
    PWGTP76::VARCHAR AS "Person's Weight replicate 76",
    PWGTP77::VARCHAR AS "Person's Weight replicate 77",
...
FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_pus/psam_pusb.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)