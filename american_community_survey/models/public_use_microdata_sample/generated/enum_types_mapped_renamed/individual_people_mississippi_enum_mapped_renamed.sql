-- SQL transformation for psam_p28 generated by generate_sql_with_enum_types_and_mapped_values_renamed.py
{{ config(materialized='external', location=var('output_path') + '/individual_people_mississippi_enum_types_mapped_renamed.parquet') }}
...
FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_pms/psam_p28.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)