-- SQL transformation for psam_p36 generated by generate_sql_with_enum_types_and_mapped_values_renamed.py
{{ config(materialized='external', location=var('output_path') + '/individual_people_new_york_enum_types_mapped_renamed.parquet') }}
