-- SQL transformation for psam_p15 generated by generate_sql_with_enum_types_and_mapped_values_renamed.py
{{ config(materialized='external', location=var('output_path') + '/individual_people_hawaii_enum_types_mapped_renamed.parquet') }}
...
FROM read_csv('/Users/me/data/american_community_survey/2022/1-Year/csv_phi/psam_p15.csv', 
              parallel=False,
              all_varchar=True,
              auto_detect=True)