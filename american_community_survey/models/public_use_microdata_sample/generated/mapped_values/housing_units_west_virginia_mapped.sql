-- SQL transformation for psam_h54 generated by generate_sql_with_mapped_values.py


{{ config(materialized='external', location=var('output_path') + '/housing_units_west_virginia.parquet') }}
SELECT
	CASE RT
