-- SQL transformation for psam_h15 generated by generate_sql_with_mapped_values.py


{{ config(materialized='external', location=var('output_path') + '/housing_units_hawaii.parquet') }}
SELECT
	CASE RT
