-- SQL transformation for psam_h32 generated by generate_sql_with_mapped_values.py


{{ config(materialized='external', location=var('output_path') + '/housing_units_nevada.parquet') }}
SELECT
	CASE RT
