-- SQL transformation for psam_husa generated by generate_sql_with_mapped_values.py


{{ config(materialized='external', location=var('output_path') + '/housing_units_united_states_first_tranche.parquet') }}
SELECT
	CASE RT
