-- SQL transformation for psam_h45 generated by generate_sql_with_mapped_values.py


{{ config(materialized='external', location=var('output_path') + '/housing_units_south_carolina.parquet') }}
SELECT
	CASE RT
