-- SQL transformation for psam_h30 generated by generate_sql_with_mapped_values.py


{{ config(materialized='external', location=var('output_path') + '/housing_units_montana.parquet') }}
SELECT
	CASE RT
