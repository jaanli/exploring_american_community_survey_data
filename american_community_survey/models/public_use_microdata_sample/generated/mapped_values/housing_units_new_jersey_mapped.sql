-- SQL transformation for psam_h34 generated by generate_sql_with_mapped_values.py


{{ config(materialized='external', location=var('output_path') + '/housing_units_new_jersey.parquet') }}
SELECT
	CASE RT
