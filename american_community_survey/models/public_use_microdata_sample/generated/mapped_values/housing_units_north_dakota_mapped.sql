-- SQL transformation for psam_h38 generated by generate_sql_with_mapped_values.py


{{ config(materialized='external', location=var('output_path') + '/housing_units_north_dakota.parquet') }}
SELECT
	CASE RT
